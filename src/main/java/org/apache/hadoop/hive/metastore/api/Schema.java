            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.fieldSchemas = new ArrayList<FieldSchema>(_list170.size);
                FieldSchema _elem171;
                for (int _i172 = 0; _i172 < _list170.size; ++_i172)
                {
                  _elem171 = new FieldSchema();
                  _elem171.read(iprot);
                  struct.fieldSchemas.add(_elem171);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.properties = new HashMap<String,String>(2*_map173.size);
                String _key174;
                String _val175;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Schema struct) throws org.apache.thrift.TException {
      ...
      if (struct.fieldSchemas != null) {
        oprot.writeFieldBegin(FIELD_SCHEMAS_FIELD_DESC);
        {
          ...
          for (FieldSchema _iter177 : struct.fieldSchemas)
          {
      ...
      if (struct.properties != null) {
        oprot.writeFieldBegin(PROPERTIES_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, String> _iter178 : struct.properties.entrySet())
          {
      ...
      if (struct.isSetFieldSchemas()) {
        {
          ...
          for (FieldSchema _iter179 : struct.fieldSchemas)
          {
      ...
      if (struct.isSetProperties()) {
        {
          ...
          for (Map.Entry<String, String> _iter180 : struct.properties.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.fieldSchemas = new ArrayList<FieldSchema>(_list181.size);
          FieldSchema _elem182;
          for (int _i183 = 0; _i183 < _list181.size; ++_i183)
          {
            _elem182 = new FieldSchema();
            _elem182.read(iprot);
            struct.fieldSchemas.add(_elem182);
          }
        }
        struct.setFieldSchemasIsSet(true);
      }
      if (incoming.get(1)) {
        {
          ...
          struct.properties = new HashMap<String,String>(2*_map184.size);
          String _key185;
          String _val186;
