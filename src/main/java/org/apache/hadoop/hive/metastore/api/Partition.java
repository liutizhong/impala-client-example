            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.values = new ArrayList<String>(_list142.size);
                String _elem143;
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.parameters = new HashMap<String,String>(2*_map145.size);
                String _key146;
                String _val147;
                for (int _i148 = 0; _i148 < _map145.size; ++_i148)
                {
                  ...
                  struct.parameters.put(_key146, _val147);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Partition struct) throws org.apache.thrift.TException {
      ...
      if (struct.values != null) {
        oprot.writeFieldBegin(VALUES_FIELD_DESC);
        {
          ...
          for (String _iter149 : struct.values)
          {
      ...
      if (struct.parameters != null) {
        oprot.writeFieldBegin(PARAMETERS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, String> _iter150 : struct.parameters.entrySet())
          {
      ...
      if (struct.isSetValues()) {
        {
          ...
          for (String _iter151 : struct.values)
          {
      ...
      if (struct.isSetParameters()) {
        {
          ...
          for (Map.Entry<String, String> _iter152 : struct.parameters.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.values = new ArrayList<String>(_list153.size);
          String _elem154;
      ...
      if (incoming.get(6)) {
        {
          ...
          struct.parameters = new HashMap<String,String>(2*_map156.size);
          String _key157;
          String _val158;
          for (int _i159 = 0; _i159 < _map156.size; ++_i159)
          {
            ...
            struct.parameters.put(_key157, _val158);
          }
        }
        struct.setParametersIsSet(true);
      }
