            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partValues = new ArrayList<String>(_list0.size);
                String _elem1;
                for (int _i2 = 0; _i2 < _list0.size; ++_i2)
                {
                  _elem1 = iprot.readString();
                  struct.partValues.add(_elem1);
                }
                iprot.readListEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, HiveObjectRef struct) throws org.apache.thrift.TException {
      ...
      if (struct.partValues != null) {
        oprot.writeFieldBegin(PART_VALUES_FIELD_DESC);
        {
          ...
          for (String _iter3 : struct.partValues)
          {
      ...
      if (struct.isSetPartValues()) {
        {
          ...
          for (String _iter4 : struct.partValues)
          {
      ...
      if (incoming.get(3)) {
        {
          ...
          struct.partValues = new ArrayList<String>(_list5.size);
          String _elem6;
          for (int _i7 = 0; _i7 < _list5.size; ++_i7)
          {
            _elem6 = iprot.readString();
            struct.partValues.add(_elem6);
          }
        }
        struct.setPartValuesIsSet(true);
      }
