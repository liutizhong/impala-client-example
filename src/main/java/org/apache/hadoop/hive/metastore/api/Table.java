            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.partitionKeys = new ArrayList<FieldSchema>(_list124.size);
                FieldSchema _elem125;
                for (int _i126 = 0; _i126 < _list124.size; ++_i126)
                {
                  _elem125 = new FieldSchema();
                  _elem125.read(iprot);
                  struct.partitionKeys.add(_elem125);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.parameters = new HashMap<String,String>(2*_map127.size);
                String _key128;
                String _val129;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Table struct) throws org.apache.thrift.TException {
      ...
      if (struct.partitionKeys != null) {
        oprot.writeFieldBegin(PARTITION_KEYS_FIELD_DESC);
        {
          ...
          for (FieldSchema _iter131 : struct.partitionKeys)
          {
      ...
      if (struct.parameters != null) {
        oprot.writeFieldBegin(PARAMETERS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, String> _iter132 : struct.parameters.entrySet())
          {
      ...
      if (struct.isSetPartitionKeys()) {
        {
          ...
          for (FieldSchema _iter133 : struct.partitionKeys)
          {
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.partitionKeys = new ArrayList<FieldSchema>(_list135.size);
          FieldSchema _elem136;
          for (int _i137 = 0; _i137 < _list135.size; ++_i137)
          {
            _elem136 = new FieldSchema();
            _elem136.read(iprot);
            struct.partitionKeys.add(_elem136);
          }
        }
        struct.setPartitionKeysIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.parameters = new HashMap<String,String>(2*_map138.size);
          String _key139;
          String _val140;
          for (int _i141 = 0; _i141 < _map138.size; ++_i141)
          {
            ...
            struct.parameters.put(_key139, _val140);
          }
        }
        struct.setParametersIsSet(true);
      }
