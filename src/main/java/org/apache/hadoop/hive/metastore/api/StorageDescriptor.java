            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.cols = new ArrayList<FieldSchema>(_list90.size);
                FieldSchema _elem91;
                for (int _i92 = 0; _i92 < _list90.size; ++_i92)
                {
                  _elem91 = new FieldSchema();
                  _elem91.read(iprot);
                  struct.cols.add(_elem91);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.bucketCols = new ArrayList<String>(_list93.size);
                String _elem94;
                for (int _i95 = 0; _i95 < _list93.size; ++_i95)
                {
                  _elem94 = iprot.readString();
                  struct.bucketCols.add(_elem94);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sortCols = new ArrayList<Order>(_list96.size);
                Order _elem97;
                for (int _i98 = 0; _i98 < _list96.size; ++_i98)
                {
                  _elem97 = new Order();
                  _elem97.read(iprot);
                  struct.sortCols.add(_elem97);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.parameters = new HashMap<String,String>(2*_map99.size);
                String _key100;
                String _val101;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, StorageDescriptor struct) throws org.apache.thrift.TException {
      ...
      if (struct.cols != null) {
        oprot.writeFieldBegin(COLS_FIELD_DESC);
        {
          ...
          for (FieldSchema _iter103 : struct.cols)
          {
      ...
      if (struct.bucketCols != null) {
        oprot.writeFieldBegin(BUCKET_COLS_FIELD_DESC);
        {
          ...
          for (String _iter104 : struct.bucketCols)
          {
      ...
      if (struct.sortCols != null) {
        oprot.writeFieldBegin(SORT_COLS_FIELD_DESC);
        {
          ...
          for (Order _iter105 : struct.sortCols)
          {
      ...
      if (struct.isSetCols()) {
        {
          ...
          for (FieldSchema _iter107 : struct.cols)
          {
      ...
      if (struct.isSetBucketCols()) {
        {
          ...
          for (String _iter108 : struct.bucketCols)
          {
      ...
      if (struct.isSetSortCols()) {
        {
          ...
          for (Order _iter109 : struct.sortCols)
          {
      ...
      if (struct.isSetParameters()) {
        {
          ...
          for (Map.Entry<String, String> _iter110 : struct.parameters.entrySet())
          {
      ...
      if (incoming.get(7)) {
        {
          ...
          struct.bucketCols = new ArrayList<String>(_list114.size);
          String _elem115;
          for (int _i116 = 0; _i116 < _list114.size; ++_i116)
          {
            _elem115 = iprot.readString();
            struct.bucketCols.add(_elem115);
          }
        }
        struct.setBucketColsIsSet(true);
      }
      if (incoming.get(8)) {
        {
          ...
          struct.sortCols = new ArrayList<Order>(_list117.size);
          Order _elem118;
          for (int _i119 = 0; _i119 < _list117.size; ++_i119)
          {
            _elem118 = new Order();
            _elem118.read(iprot);
            struct.sortCols.add(_elem118);
          }
        }
        struct.setSortColsIsSet(true);
      }
