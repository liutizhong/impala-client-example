            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.properties = new HashMap<String,String>(2*_map188.size);
                String _key189;
                String _val190;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, EnvironmentContext struct) throws org.apache.thrift.TException {
      ...
      if (struct.properties != null) {
        oprot.writeFieldBegin(PROPERTIES_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, String> _iter192 : struct.properties.entrySet())
          {
      ...
      if (struct.isSetProperties()) {
        {
          ...
          for (Map.Entry<String, String> _iter193 : struct.properties.entrySet())
          {
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.properties = new HashMap<String,String>(2*_map194.size);
          String _key195;
          String _val196;
