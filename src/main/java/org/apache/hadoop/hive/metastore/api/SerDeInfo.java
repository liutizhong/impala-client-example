            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.parameters = new HashMap<String,String>(2*_map80.size);
                String _key81;
                String _val82;
                for (int _i83 = 0; _i83 < _map80.size; ++_i83)
                {
                  ...
                  struct.parameters.put(_key81, _val82);
                }
                iprot.readMapEnd();
              }
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, SerDeInfo struct) throws org.apache.thrift.TException {
      ...
      if (struct.parameters != null) {
        oprot.writeFieldBegin(PARAMETERS_FIELD_DESC);
        {
          ...
          for (Map.Entry<String, String> _iter84 : struct.parameters.entrySet())
          {
      ...
      if (struct.isSetParameters()) {
        {
          ...
          for (Map.Entry<String, String> _iter85 : struct.parameters.entrySet())
          {
