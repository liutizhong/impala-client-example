            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.privileges = new ArrayList<HiveObjectPrivilege>(_list8.size);
                HiveObjectPrivilege _elem9;
                for (int _i10 = 0; _i10 < _list8.size; ++_i10)
                {
                  _elem9 = new HiveObjectPrivilege();
                  _elem9.read(iprot);
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, PrivilegeBag struct) throws org.apache.thrift.TException {
      ...
      if (struct.privileges != null) {
        oprot.writeFieldBegin(PRIVILEGES_FIELD_DESC);
        {
          ...
          for (HiveObjectPrivilege _iter11 : struct.privileges)
          {
            _iter11.write(oprot);
          }
          oprot.writeListEnd();
      ...
      if (struct.isSetPrivileges()) {
        {
          ...
          for (HiveObjectPrivilege _iter12 : struct.privileges)
          {
            _iter12.write(oprot);
          }
        }
      ...
      if (incoming.get(0)) {
        {
          ...
          struct.privileges = new ArrayList<HiveObjectPrivilege>(_list13.size);
          HiveObjectPrivilege _elem14;
          for (int _i15 = 0; _i15 < _list13.size; ++_i15)
          {
            _elem14 = new HiveObjectPrivilege();
            _elem14.read(iprot);
