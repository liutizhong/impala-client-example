            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.MAP) {
              {
                ...
                struct.parameters = new HashMap<String,String>(2*_map160.size);
                String _key161;
                String _val162;
      ...
      if (struct.isSetParameters()) {
        {
          ...
          for (Map.Entry<String, String> _iter165 : struct.parameters.entrySet())
          {
      ...
      if (incoming.get(8)) {
        {
          ...
          struct.parameters = new HashMap<String,String>(2*_map166.size);
          String _key167;
          String _val168;
