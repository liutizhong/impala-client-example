...
public class ImpalaService {
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends com.cloudera.beeswax.api.BeeswaxService.AsyncProcessor<I> {
    ...
    public static class GetExecSummary<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, GetExecSummary_args, com.cloudera.impala.thrift.TExecSummary> {
      public GetExecSummary() {
        super("GetExecSummary");
      }
      ...
      public AsyncMethodCallback<com.cloudera.impala.thrift.TExecSummary> getResultHandler(final AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new AsyncMethodCallback<com.cloudera.impala.thrift.TExecSummary>() { 
          public void onComplete(com.cloudera.impala.thrift.TExecSummary o) {
            GetExecSummary_result result = new GetExecSummary_result();
            result.success = o;
            try {
              fcall.sendResponse(fb,result, org.apache.thrift.protocol.TMessageType.REPLY,seqid);
      ...
      public void start(I iface, GetExecSummary_args args, org.apache.thrift.async.AsyncMethodCallback<com.cloudera.impala.thrift.TExecSummary> resultHandler) throws TException {
